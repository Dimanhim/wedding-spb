...
$this->title = 'Цвета для сайта';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-color-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Добавить цвет для сайта', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model, $key) {
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
                            ...
                            'title' => 'Удалить',
                            'data' => [
                                'confirm' => 'Вы уверены, что хотите удалить цвет для сайта?',
                                'method' => 'post',
                            ],
                        ]);
                    },
