                    ...
                    <?php if (count($sizes)): ?>
                        ...
                        <tr>
                            <?php foreach ($sizes as $key => $size): ?>
                                <td>
                                    <?php
                                        $size_amount_query1 = $model->getAmounts()->where(['size_id' => $key, 'amount_type' => Amount::TYPE_HALL])->one();
                        ...
                        <tr>
                            <?php foreach ($sizes as $key => $size): ?>
                                <td>
                                    <?php
                                        $size_amount_query2 = $model->getAmounts()->where(['size_id' => $key, 'amount_type' => Amount::TYPE_WAREHOUSE])->one();
                        ...
                        <tr>
                            <?php foreach ($sizes as $key => $size): ?>
                                <td>
                                    <?php
                                        $size_amount_query3 = $model->getAmounts()->where(['product_id' => $model->id, 'size_id' => $key, 'amount_type' => Amount::TYPE_WAIT])->one();
