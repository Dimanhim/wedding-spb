...
<div class="product-index">
    ...
    <div class="search_block">
        ...
        <?= $this->render('_search', ['model' => $searchModel, 'category_id' => $category->id, 'type' => $type, 'is_deleted' => Yii::$app->request->get('is_deleted')]); ?>
    </div>
    ...
    <form action="" id="products_form">
        <?php if (Yii::$app->user->identity->role != 'admin') $template_folder = 'sale-indexes'; ?>
        <?= 
